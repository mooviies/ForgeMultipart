...
public class PerspectiveAwareBakedModel extends AbstractBakedPropertiesModel {
    ...
    public PerspectiveAwareBakedModel(Map<Direction, List<BakedQuad>> faceQuads, IModelTransform state, ModelProperties properties) {
        this(faceQuads, ImmutableList.of(), state, properties);
    }

    public PerspectiveAwareBakedModel(List<BakedQuad> generalQuads, IModelTransform state, ModelProperties properties) {
        this(ImmutableMap.of(), generalQuads, state, properties);
    }

    public PerspectiveAwareBakedModel(Map<Direction, List<BakedQuad>> faceQuads, List<BakedQuad> generalQuads, IModelTransform state, ModelProperties properties) {
