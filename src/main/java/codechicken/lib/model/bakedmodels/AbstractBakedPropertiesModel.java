...
public abstract class AbstractBakedPropertiesModel implements IModelParticleProvider, IBakedModel {
    ...
    @Override
    public Set<TextureAtlasSprite> getHitEffects(@Nonnull BlockRayTraceResult traceResult, BlockState state, ILightReader world, BlockPos pos, IModelData modelData) {
    ...
    @Override
    public Set<TextureAtlasSprite> getDestroyEffects(BlockState state, ILightReader world, BlockPos pos, IModelData data) {
