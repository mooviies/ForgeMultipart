...
public class ModelProperties implements Copyable<ModelProperties> {
    ...
    public static class PerspectiveProperties extends ModelProperties {
        ...
        public PerspectiveProperties(IModelTransform state, boolean isAO, boolean isGui3D) {
            this(state, isAO, isGui3D, false, null);
        }

        public PerspectiveProperties(IModelTransform state, boolean isAO, boolean isGui3D, boolean isBuiltInRenderer, TextureAtlasSprite particle) {
        ...
        public PerspectiveProperties(IModelTransform state, ModelProperties properties) {
            super(properties);
            this.modelState = state;
        }

        public IModelTransform getModelState() {
            return modelState;
        }
        ...
        public static class PerspectiveBuilder extends Builder {
            ...
            @Override
            public PerspectiveBuilder withState(IModelTransform state) {
                this.state = state;
                return this;
            }
