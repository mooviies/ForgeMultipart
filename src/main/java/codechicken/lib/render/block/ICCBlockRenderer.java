...
public interface ICCBlockRenderer {
     ...
     */
    boolean canHandle(ILightReader world, BlockPos pos, BlockState blockState);
     ...
     */
    default boolean canHandle(ILightReader world, BlockPos pos, IFluidState fluidState) {
        return false;
    }
     ...
     */
    @OnlyIn (Dist.CLIENT)
    default void handleRenderBlockDamage(ILightReader world, BlockPos pos, BlockState state, TextureAtlasSprite sprite, BufferBuilder buffer) {
    }
     ...
     */
    @OnlyIn (Dist.CLIENT)
    boolean renderBlock(ILightReader world, BlockPos pos, BlockState state, BufferBuilder buffer, Random random, IModelData modelData);
     ...
     */
    @OnlyIn (Dist.CLIENT)
    default boolean renderFluid(ILightReader world, BlockPos pos, IFluidState fluidState, BufferBuilder buffer) {
        return false;
    }
