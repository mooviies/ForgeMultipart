...
public interface IModelParticleProvider extends IBakedModel {
     ...
     */
    Set<TextureAtlasSprite> getHitEffects(@Nonnull BlockRayTraceResult traceResult, BlockState state, ILightReader world, BlockPos pos, IModelData modelData);
     ...
     * @return A Set of Textures to use.
     */
    Set<TextureAtlasSprite> getDestroyEffects(BlockState state, ILightReader world, BlockPos pos, IModelData data);
