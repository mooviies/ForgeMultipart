...
import codechicken.lib.render.CCModelTransform;
...
public class TransformUtils {
    ...
    public static final CCModelTransform DEFAULT_BLOCK;
    public static final CCModelTransform DEFAULT_ITEM;
    public static final CCModelTransform DEFAULT_TOOL;
    public static final CCModelTransform DEFAULT_BOW;
    public static final CCModelTransform DEFAULT_HANDHELD_ROD;
    ...
    static {
        ...
        DEFAULT_BLOCK = new CCModelTransform(map);
        ...
        DEFAULT_ITEM = new CCModelTransform(map);
        ...
        DEFAULT_TOOL = new CCModelTransform(map);
        ...
        DEFAULT_BOW = new CCModelTransform(map);
        ...
        DEFAULT_HANDHELD_ROD = new CCModelTransform(map);
        //@formatter:on
    }
        ...
        if (json.has("transform")) {
            ...
            if (transformElement.isJsonPrimitive() && transformElement.getAsJsonPrimitive().isString()) {
                ...
                if (transforms.isEmpty()) {
                    ...
                    state = new CCModelTransform(Maps.immutableEnumMap(transforms), Optional.of(base));
                }
